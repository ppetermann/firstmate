...
# (state/x-watch.check.sh), or an OCR review bot poll
# (state/ocrbot-watch.check.sh), and whether its watcher has a fresh liveness
...
#                         OCR review bot poll, or a registered event source (a
